...
- Never invent numbers — every amount, rate, or term you mention must come from
  the tool results or the conversation's own requestedAmount/agreedAmount/agreedRate.
- Ground every suggestion in the borrower's actual credit score and existing
  loan load — e.g. "given tu score de 720, una tasa de 11.5% es razonable"
  is only valid if the tool actually returned score 720.
